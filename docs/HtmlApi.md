...
------------- | ------------- | -------------
[**get**](HtmlApi.md#get) | **GET** /api/async/html/result/{taskId} | Tries to get the result of a request using the task id of the request
[**post**](HtmlApi.md#post) | **POST** /api/async/html | Analyses HTML and adds suggestion tags to it
...
var apiInstance = new ProWritingAidApi.HtmlApi();
...
var requestp = new ProWritingAidApi.HtmlAnalysisRequest(); // HtmlAnalysisRequest | 
