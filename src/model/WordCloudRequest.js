...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProWritingAidApi.WordCloudRequest = factory(root.ProWritingAidApi.ApiClient);
  }
   ...
   * @param maximumWordCount {Integer} the maximum number of words to be created
   ...
   * @param width {Integer} The width of the image to produce
   * @param height {Integer} The height of the image to produce
   ...
   * @param language {module:model/WordCloudRequest.LanguageEnum} Document's language  <remarks>  Set correct UK/US language to get region-specific suggestions  </remarks>
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('MaximumWordCount')) {
        obj['MaximumWordCount'] = ApiClient.convertToType(data['MaximumWordCount'], 'Integer');
      }
   ...
   */
  exports.prototype['CaseMethod'] = undefined;
  /**
   * The name of the palette
   * @member {String} PaletteName
   */
  exports.prototype['PaletteName'] = undefined;
  /**
   * the maximum number of words to be created
   * @member {Integer} MaximumWordCount
   */
  exports.prototype['MaximumWordCount'] = undefined;
  /**
   * Should Common words be removed from the cloud
   * @member {Boolean} RemoveCommonWords
   */
  exports.prototype['RemoveCommonWords'] = undefined;
  /**
   ...
   */
  exports.prototype['OnlySentimentWords'] = undefined;
  /**
