...
(function(root, factory) {
  ...
  /**
   * AsyncContextualThesaurusResult service.
   * @module api/AsyncContextualThesaurusResultApi
   * @version v1
   */

  /**
   * Constructs a new AsyncContextualThesaurusResultApi. 
   * @alias module:api/AsyncContextualThesaurusResultApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.asyncContextualThesaurusResultGetResult = function(taskId, licenseCode) {
      var postBody = null;

      // verify the required parameter 'taskId' is set
      if (taskId == undefined || taskId == null) {
        throw "Missing the required parameter 'taskId' when calling asyncContextualThesaurusResultGetResult";
      }
