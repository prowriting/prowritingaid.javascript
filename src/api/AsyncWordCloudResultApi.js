...
(function(root, factory) {
  ...
  /**
   * AsyncWordCloudResult service.
   * @module api/AsyncWordCloudResultApi
   * @version v1
   */

  /**
   * Constructs a new AsyncWordCloudResultApi. 
   * @alias module:api/AsyncWordCloudResultApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.asyncWordCloudResultGetResult = function(taskId, licenseCode) {
      var postBody = null;

      // verify the required parameter 'taskId' is set
      if (taskId == undefined || taskId == null) {
        throw "Missing the required parameter 'taskId' when calling asyncWordCloudResultGetResult";
      }
